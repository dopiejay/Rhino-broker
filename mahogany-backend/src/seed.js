    ...
    slides: [
      {
        ...
        title: "Cover that's arranged with care, not just sold.",
        body: "We compare across Malawi's trusted insurers to find the policy that actually fits your risk.",
      ...
      },
      {
        ...
        body: "Fire, liability, engineering and marine cover, tailored to how your business actually operates.",
        ctaLabel: "Explore Business Cover",
        ctaTo: "/services",
      },
      {
        eyebrow: "Motor Insurance",
        title: "Drive with the right cover behind you.",
        body: "Private and commercial vehicle insurance, compared across insurers for the best fit.",
        ctaLabel: "See Motor Options",
        ctaTo: "/services",
      },
      {
        eyebrow: "Claims Support",
        title: "We stay with you after the sale.",
        body: "When it's time to claim, we handle the paperwork and follow up with the insurer for you.",
        ctaLabel: "See How Claims Work",
        ctaTo: "/claims",
      },
    ],
  },

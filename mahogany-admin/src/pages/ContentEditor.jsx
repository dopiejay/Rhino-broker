  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <p className="text-sm text-ink/55 mb-8 max-w-2xl">
        Only critical details are editable here. The rest of the website content is managed in code.
      </p>
      ...
      <SectionCard
        title="FAQs"
        description="Questions and answers shown on the Resources page and the Claims page."
        onSave={() => save("faqs")}
        {...st("faqs")}
      >
        <RepeatableList
